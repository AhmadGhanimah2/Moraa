				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='Ahmad') }}">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">الفواتير الغير مدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">الفواتير الجزئيه</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">قائمه المستخدمين</a></li>
						</ul>
					</li>
